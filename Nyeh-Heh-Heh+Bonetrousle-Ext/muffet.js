var muffet = new Howl({
	src: ["audio/Nyeh-Heh-Heh+Bonetrousle-Extended.mp3"],
	loop: true,
});
...
function update() {
	...
	document.getElementById("muffet").style.left = ((rate - Math.random() * rate * 2)+((divwidth-585)/2)) + "px";
