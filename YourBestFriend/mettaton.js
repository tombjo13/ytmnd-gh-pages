var mettaton = new Howl({
	src: ["audio/Undertale OST 003 - Your Best Friend.ogg", "audio/Undertale OST 003 - Your Best Friend.mp3"],
	loop: true,
});

var update_time = new Date();

var percent_time = 0.61686;
...
function update() {
	...
	document.getElementById("mettaton").style.left = (rate - Math.min(Math.max(parseInt(Math.random() * rate * 2), -48), 48)+(divwidth-645)/2) + "px";
