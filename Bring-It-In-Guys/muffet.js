var muffet = new Howl({
	src: ["audio/Undertale OST 095 - Bring It In Guys!.mp3"],
	loop: true,
});

var update_time = new Date();

var percent_time = 1.37686;
...
function update() {
	...
	document.getElementById("muffet").style.left = ((rate - Math.random() * rate * 2)+((divwidth-1725)/2)) + "px";
