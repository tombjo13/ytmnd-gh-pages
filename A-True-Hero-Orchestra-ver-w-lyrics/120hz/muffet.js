var muffet = new Howl({
	src: ["audio/A True Hero - Orchestra ver. w_ FanLyric.mp3"],
	loop: true,
});

var update_time = new Date();

var percent_time = 1.25;
...
function update() {
	...
	document.getElementById("muffet").style.left = ((rate - Math.random() * rate * 2)+((divwidth-910)/2)) + "px";
